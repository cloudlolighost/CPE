...
class Cpe(models.Model):
    ...
    users_solving = models.FloatField(db_column='Users_Solving', blank=True, null=True)  # Field name made lowercase.
    ...
    users_solving_persent = models.TextField(db_column='Users_Solving_persent', blank=True, null=True)  # Field name made lowercase.
